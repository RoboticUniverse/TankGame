...
class Menu:
    ...
    def create_buttons(self):
        ...
        # Player 1
        # 1
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 175, 100, 50), "Player 1", -1, (0, 0, 0), (255, 255, 255)))
        ...
        # 2
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 100, 100, 50), "Mouse", 5, (255, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2)
        # 3
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 25, 100, 50), "Auto-Turn", 9, (255, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2)
        # 4
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 50, 100, 50), "Tolerance", -1, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2)
        # 5
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), "<", 13, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2 - 50)
        # 6
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), "20", -1, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2)
        # 7
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), ">", 17, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2 + 50)
        # 8
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 200, 100, 50), "Color", -1, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2)
        # 9
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 100, 50), "<", 21, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2 - 50)
        # 10
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 50, 50), "", -1, (0, 255, 0), (255, 255, 255), False, False, 0))
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2)
        # 11
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 100, 50), ">", 25, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 - self.control_buttons[-1].get_width() / 2 + 50)
        # Player 2
        # 12
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 175, 100, 50), "Player 2", -1, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2)
        # 13
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 100, 100, 50), "Mouse", 6, (255, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2)
        # 14
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 25, 100, 50), "Auto-Turn", 10, (255, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2)
        # 15
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 50, 100, 50), "Tolerance", -1, (0, 0, 0), (150, 150, 150)))
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2)
        # 16
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), "<", 14, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2)
        # 18
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), ">", 18, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2 + 50)
        # 19
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 200, 100, 50), "Color", -1, (0, 0, 0), (255, 255, 255)))
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2)
        # 20
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 100, 50), "<", 22, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2 - 50)
        # 21
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 50, 50), "", -1, (0, 0, 255), (255, 255, 255), False, False, 1))
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2)
        # 22
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 100, 50), ">", 26, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 2 - self.control_buttons[-1].get_width() / 2 + 50)
        # Player 3
        # 23
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 175, 100, 50), "Player 3", -1, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2)
        # 24
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 100, 100, 50), "Mouse", 7, (255, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2)
        # 25
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 25, 100, 50), "Auto-Turn", 11, (255, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2)
        # 26
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 50, 100, 50), "Tolerance", -1, (0, 0, 0), (150, 150, 150)))
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2)
        # 27
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), "<", 15, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2)
        # 29
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), ">", 19, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2 + 50)
        # 30
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 200, 100, 50), "Color", -1, (0, 0, 0), (255, 255, 255)))
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2)
        # 31
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 100, 50), "<", 23, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2 - 50)
        # 32
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 50, 50), "", -1, (255, 255, 0), (255, 255, 255), False, False, 2))
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2)
        # 33
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 100, 50), ">", 27, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 3 - self.control_buttons[-1].get_width() / 2 + 50)
        # Player 4
        # 34
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 175, 100, 50), "Player 4", -1, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2)
        # 35
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 100, 100, 50), "Mouse", 8, (255, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2)
        # 36
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 - 25, 100, 50), "Auto-Turn", 12, (255, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2)
        # 37
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 50, 100, 50), "Tolerance", -1, (0, 0, 0), (150, 150, 150)))
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2)
        # 38
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), "<", 16, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2)
        # 40
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 125, 100, 50), ">", 20, (0, 0, 0), (150, 150, 150)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2 + 50)
        # 41
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 200, 100, 50), "Color", -1, (0, 0, 0), (255, 255, 255)))
        ...
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2)
        # 42
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 100, 50), "<", 24, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2 - 50)
        # 43
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 50, 50), "", -1, (255, 0, 255), (255, 255, 255), False, False, 3))
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2)
        # 44
        self.control_buttons.append(Button(Rect(self.surface.get_width() / 2 - 50, self.surface.get_height() / 2 + 275, 100, 50), ">", 28, (0, 0, 0), (255, 255, 255)))
        self.control_buttons[-1].set_text_size(45)
        self.control_buttons[-1].set_x(self.surface.get_width() / 5 * 4 - self.control_buttons[-1].get_width() / 2 + 50)
        # 45
